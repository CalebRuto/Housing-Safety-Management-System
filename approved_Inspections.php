...
$sql ="SELECT * FROM approved_inspections
        WHERE
            approved_inspections.Id ";
              ...
              <div class="panel-heading">
                <div class="row">
                  <div class="col col-xs-6">
                    <h3 class="panel-title">Approved Inspections</h3>
                    <a href="exportData_3.php" style="margin:-35px 0px 0px 850px ;" class="btn btn-success pull-right">Generate Reports</a>
                  </div>
