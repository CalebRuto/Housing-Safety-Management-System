...
$sql ="SELECT permits.Id, permits.civil_permit, sanitarypermits.sanitary_permit, mechanicalpermits.mechanical_permit,
                ...
                <table class="table table-striped table-bordered table-list" style="width:1000px;">
                  <thead>
                    <tr>
                        ...
                        <th>Plumbing Permit</th>
                        <th>Electronic Permit</th>
                    </tr>
                  </thead>
                  <tbody>
                    <?php
                    ...
                    ?>
                          <tr>
                            <td align="center">
<button onclick="window.location.href='accept.php';" type="submit" class="btn btn-sm btn-primary btn-create">Approve</button>
<button onclick="window.location.href='reject.php';" type="submit" class="btn btn-sm btn-secondary btn-create">Deny</button>
                            </td>
                            <td class="hidden-xs"><?php echo $row['Id']; ?></td>
                            <td><?php echo $row['civil_permit']; ?></td>
                            <td><?php echo $row['sanitary_permit']; ?></td>
                            <td><?php echo $row['mechanical_permit']; ?></td>
                            <td><?php echo $row['electrical_permit']; ?></td>
                            <td><?php echo $row['plumbing_permit']; ?></td>
                            <td><?php echo $row['electronics_permit']; ?> </td>
                          </tr>
                      <?php
                    }
                  }
