                            ...
                            <div class="collapse navbar-collapse" id="navcol-1" style="height:100px;">
                                ...
                                <ul class="nav navbar-nav ml-auto">
                                    <li class="nav-item" role="presentation">
                                      <a class="nav-link active" href="#">Sign In</a></li>
                                    <li class="nav-item" role="presentation">
    ...
    <div class="row" style="height:550px;">
        <div class="col-xl-2 flex-fill" style="padding:0px ;">
            <div class="flex-grow-1 visible vertical-nav" style="width:200px;margin:0px 0px 0px 0px;">
                ...
                <h4>HSMS Vertical Navigation</h4>
                  ...
                  <div class="row">
                      <div class="col-md-12">
                          <div class="page-header clearfix">
                              <h3 class="pull-left">Construction Company Details</h3>
                              <a href="create.php" class="btn btn-success pull-right">Add New Details</a>
                          </div>
                          <?php
                          // Include config file
                          require_once "config.php";
                          // Attempt select query execution
                          $sql = "SELECT * FROM contractor_company";
                              ...
                              if(mysqli_num_rows($result) > 0){
                                  echo "<table class='table table-bordered table-striped'>";
                                      echo "<thead>";
                                          echo "<tr>";
                                              echo "<th>#</th>";
                                              echo "<th>Contractor_Id</th>";
                                              echo "<th>QuantityS_Id</th>";
                                              echo "<th>Architect_Id</th>";
                                              echo "<th>Engineer_Id</th>";
                                              echo "<th>Action</th>";
                                          echo "</tr>";
                                      echo "</thead>";
                                      echo "<tbody>";
                                      while($row = mysqli_fetch_array($result)){
                                          echo "<tr>";
                                              ...
                                              echo "<td>" . $row['QuantityS_Id'] . "</td>";
                                              echo "<td>" . $row['Architect_Id'] . "</td>";
