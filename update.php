...
if(isset($_POST["Id"]) && !empty($_POST["Id"])){
    ...
    if(empty($Username_err) && empty($Password_err)){
        ...
        $sql = "UPDATE user_info SET Username=?, Password=? WHERE Id=?";
         
        if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "sssi", $param_name, $param_Password, $param_Created_at, $param_Id);
                ...
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" method="post">
                        ...
                        <div class="form-group <?php echo (!empty($Password_err)) ? 'has-error' : ''; ?>">
                            ...
                            <textarea name="address" class="form-control"><?php echo $Password; ?></textarea>
