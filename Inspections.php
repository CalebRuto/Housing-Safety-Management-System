            ...
            <div class="col-md-12 dh-header-non-rectangular-container">
                ...
                <div class="col-md-12">
                    <div class="col-md-4 col-md-offset-4">
                      <button onclick="window.location.href='Contractor.php';" class="btn btn-light btn-lg btn-success" type="button" style="margin:5px;">C Portal</button>
                      <button onclick="window.location.href='Permits.php';" class="btn btn-light btn-lg btn-primary" type="button" style="margin:5px;">&nbsp; &nbsp;Permits &nbsp; &nbsp;</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row articles">
                <div class="col-sm-6 col-md-4 item">
                  <a href="#"><img class="img-fluid" src="assets/img/desk.jpg"></a>
                     <h3 class="name">Occupancy Certificate</h3>
                       <form method="post" action="occupancy_rand.php">
                    ...
                    <p class="description">Aenean tortor est, vulputate quis leo in, vehicula rhoncus lacus. Praesent aliquam in tellus eu gravida. Aliquam varius finibus est, interdum justo suscipit id.</p><a href="#" class="action"></a></div>
                <div class="col-sm-6 col-md-4 item">
                  <a href="#"><img class="img-fluid" src="assets/img/building.jpg"></a>
                    <h3 class="name">Fire Safety Clearance</h3>
                        <form method="post" action="firesafety_rand.php">
                          Randomized ID: <input type="text" name="length" value="" />
                          <button class="btn btn-primary" type="submit" name="generate" style="margin:10px;">Generate</button>
                        </form>
                    <p class="description">Aenean tortor est, vulputate quis leo in, vehicula rhoncus lacus. Praesent aliquam in tellus eu gravida. Aliquam varius finibus est, interdum justo suscipit id.</p><a href="#" class="action"></a></div>
                <div class="col-sm-6 col-md-4 item"><a href="#">
                  <img class="img-fluid" src="assets/img/loft.jpg"></a>
                    <h3 class="name">NEMA Approval</h3>
                        <form method="post" action="nema_rand.php">
                            Randomized ID: <input type="text" name="length" value="" />
                            <button class="btn btn-primary" type="submit" name="generate" style="margin:10px;">Generate</button>
                        </form>
                    <p class="description">Aenean tortor est, vulputate quis leo in, vehicula rhoncus lacus. Praesent aliquam in tellus eu gravida. Aliquam varius finibus est, interdum justo suscipit id.</p><a href="#" class="action"></a></div>
